...
exports.productPage = class productPage {
  constructor(page) {
    ...
    this.quantitiyDecrease_button = page.locator(
      '[data-zta="quantityStepperDecrementButton"]',
    );
    this.addToCart_button = page.locator('[data-zta="add-to-cart-button"]');
    this.quantityIncrease_button = page.locator(
      '[data-zta="quantityStepperIncrementButton"]',
    );
    this.ingredients_button = page.locator(
      '[data-zta="productAnchorsIngredients"]',
    );
    this.productFeedingRecommendations_button = page.locator(
      '[data-zta="productAnchorsFeedingRecommendation"]',
    );
    ...
    this.quantityCounter_text = page.locator(
      '[data-zta="quantityStepperInput"]',
    );
    this.popupProductInCart_text = page.locator(
      '[data-testid="addToCartPopoverText"]',
    );
    ...
    this.feedingRecommendation_section = page.locator([
      'data-zta="feedingrecommendation"',
    ]);
    this.ingredients_section = page.locator('#ingredients');
    this.productRecommendation_section = page.locator(
      '[data-zta="feedingrecommendation"]',
    );
  }
  ...
  async goToPage() {
    await this.page.goto(
      'https://www.zooplus.pl/shop/koty/karma_dla_kota_mokra/purizon/adult/1224918?origin=hopps&q=purizon&i=7&ro=10',
    );
  }
  ...
  async productFeedingRecommendationsAreVisible(recommendation) {
    ...
    await expect(this.productRecommendation_section).toContainText(
      `${recommendation}`,
    );
  }
  ...
  async addingAnItemToCart() {
    ...
    await expect(this.popupProductInCart_text).toHaveText(
      '1 produkt w koszyku',
    );
  }
