...
exports.landingPage = class landingPage {
  constructor(page) {
    ...
    this.leftbackground_image = page.locator(
      '[class="BackgroundBanner-module_leftImage__GFWBA"]',
    );
    this.rightbackground_image = page.locator(
      '[class="BackgroundBanner-module_rightImage__r5yBK"]',
    );
    this.searchbox_textbox = page.locator('#search_query_field_desktop');
    this.searchbox_button = page.locator(
      '[type="submit"][data-zta="search_form_button_desktop"]',
    );
    ...
    this.recommendation_section = page.locator(
      '[class="RecommendationSlider_sliderContainer__HMQ6h"]',
    );
    this.sidebanner_section = page.locator('[data-testid="side-banner"]');
    this.infolist_section = page.locator(
      '[class="InfoListAndCountrySelector-module_infoList__DTNyj"]',
    );
    this.purchasedetails_section = page.locator(
      '[class="PurchaseDetails-module_paymentShippingAndTrust__0p7i3"]',
    );
    this.socialandapps_section = page.locator(
      '[class="SocialAndApps-module_socialAndApps__OLYLe"]',
    );
    this.legallinks_section = page.locator(
      '[class="LegalLinks-module_legalLinks__5Jdza"]',
    );
  }
  ...
  async searchboxFill(product) {
    ...
    await expect(
      this.page.getByText('Tutaj znajdziesz wyniki dla ' + product + ''),
    ).toBeVisible();
  }
};
